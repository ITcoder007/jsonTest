...
public class JacksonTest {
    ...
    public void obj2String(){
        ...
        String res1 = JsonUtil.obj2String(student);
        // {"name":"小明儿","age":18,"profileImageUrl":""}
        System.out.println(res1);
        res1 = JsonUtil.obj2StringPretty(student);
        /*
            {
              "name" : "小明儿",
              "age" : 18,
        ...
        String res2 = JsonUtil.obj2String(map);
        // {"a":[1,2,3],"b":[4,5,6]}
        System.out.println(res2);
        res2 = JsonUtil.obj2StringPretty(map);
        /*
            {
              "a" : [ 1, 2, 3 ],
              "b" : [ 4, 5, 6 ]
    ...
    public void string2Obj() {
        ...
        students.add(student);
        String listStr = JsonUtil.obj2String(students);
        // [{"name":"小明儿","age":18,"profileImageUrl":""},{"name":"小明儿","age":18,"profileImageUrl":""}]
        System.out.println(listStr);
        List list = JsonUtil.string2Obj(listStr, List.class);
        // [{name=小明儿, age=18, profileImageUrl=}, {name=小明儿, age=18, profileImageUrl=}]
        System.out.println(list);

        list = JsonUtil.string2Obj(listStr, new TypeReference<List<Student>>(){});
        // [entity.Student(name=小明儿, age=18, profileImageUrl=), entity.Student(name=小明儿, age=18, profileImageUrl=)]
        System.out.println(list);

        list = JsonUtil.string2Obj(listStr, List.class , Student.class);
        // [entity.Student(name=小明儿, age=18, profileImageUrl=), entity.Student(name=小明儿, age=18, profileImageUrl=)]
        System.out.println(list);

        String mapStr = "{\"a\":[1,2,3],\"b\":[4,5,6]}";
        Map map = JsonUtil.string2Obj(mapStr, Map.class);
        // {a=[1, 2, 3], b=[4, 5, 6]}
    ...
    public void jsonIgnore() {
        ...
        StudentIgnore student1 = JsonUtil.string2Obj(str, StudentIgnore.class);
    ...
    public void jsonPro() {
        ...
        StudentPro student1 = JsonUtil.string2Obj(str, StudentPro.class);
    ...
    public void jsonDateFormat() {
        ...
        // 反序列化
        StudentBirth student1 = JsonUtil.string2Obj(result, StudentBirth.class);
    ...
    public void jsonIgnoreUnknown() {
        ...
        // 反序列化: 正常
        StudentBirth student1 = JsonUtil.string2Obj(str, StudentBirth.class);
        // StudentBirth(name=name, age=10, profileImageUrl=link, birthDay=Thu Apr 25 17:04:14 CST 2019)
        System.out.println(student1);

        // 反序列化: 有未知属性
        try {
            Student student2 = JsonUtil.string2Obj(str, Student.class);
            // StudentBirth(name=name, age=10, profileImageUrl=link, birthDay=Thu Apr 25 17:04:14 CST 2019)
        ...
        // 反序列化： 忽略未知属性
        StudentIgnoreUnkown student3 = JsonUtil.string2Obj(str, StudentIgnoreUnkown.class);
        // StudentBirth(name=name, age=10, profileImageUrl=link, birthDay=Thu Apr 25 17:04:14 CST 2019)
    ...
    public void jsonTreeMode() throws IOException {
        ...
        JsonNode jsonNode = JsonUtil.objectMapper.readTree(str);
